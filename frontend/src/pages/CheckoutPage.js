...
import { CreditCard, Lock, Truck, MapPin, Banknote, CheckCircle } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const orderData = {
        ...
        payment_method: paymentType === 'pay_on_delivery' ? 'cash' : paymentMethod,
      ...
      if (paymentType === 'pay_on_delivery') {
        toast.success('Order confirmed! Payment will be collected upon delivery.');
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-4 p-4 bg-amber-50 rounded-lg flex items-start space-x-3">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-amber-800">${settings?.delivery_base_fee || 10} for first 5km + ${settings?.delivery_per_km_fee || 2}/km additional</p>
                      <p className="text-amber-800">Free delivery on orders over ${settings?.free_delivery_threshold || 50}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  ...
                  {!onlinePaymentsEnabled && (
                    <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                      ...
                      <p className="text-sm text-amber-600 mt-1">Online payments are currently disabled. Please pay cash when you receive your order.</p>
                    </div>
                  )}
                  
                  {/* Payment Type Toggle */}
                  <div className={`grid ${onlinePaymentsEnabled ? 'md:grid-cols-2' : 'md:grid-cols-1'} gap-4 mb-6`}>
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600">Cash or card at delivery</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {paymentType === 'pay_on_delivery' && (
                    <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="text-sm">
                          <p className="font-semibold text-green-900">Pay When You Receive</p>
                          <p className="text-green-800 mt-1">
                            Your order will be confirmed immediately. Pay with cash or card when your order is delivered.
                          </p>
                          <p className="text-green-700 mt-2 text-xs">
                            * Our delivery person will carry a card machine for your convenience
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <Card className="sticky top-24">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4 mb-6 max-h-64 overflow-y-auto">
                    {cart.map((item) => (
                      <div key={item.id || item.product_id} className="flex space-x-3">
                        <img
                          src={item.image}
                          alt={item.name}
