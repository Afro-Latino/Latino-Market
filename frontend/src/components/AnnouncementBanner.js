...
export const AnnouncementBanner = () => {
  ...
  const visibleAnnouncements = announcements.filter(a => !dismissed.includes(a.announcement_id));
  ...
  return (
    <div className={`${getBgColor(currentAnnouncement.type)} text-white py-3 px-4 relative`}>
